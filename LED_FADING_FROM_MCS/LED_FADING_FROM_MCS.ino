...
#include <LDateTime.h>
#define WIFI_AP "ORL" //Input your wifi ap name
#define WIFI_PASSWORD "orl_india" // Input your wifi password
#define WIFI_AUTH LWIFI_WPA  // choose from LWIFI_OPEN, LWIFI_WPA, or LWIFI_WEP.
#define per 50
#define per1 3
#define DEVICEID "DYx94ojB" // Input your deviceId
#define DEVICEKEY "Lft3eEbYHsSjDEKq" // Input your deviceKey
  ...
  while (c.available())
   {
      ...
      {
        tcpcmd += (char)v;
        Value = tcpcmd.substring(parseString);  
        if (Value.length() > 0) {
          processed = 1;
        }
      }
